...
function preload() {
  dreamer = loadSound("../assets/sound/lipGloss.mp3");
}
...
function draw() {
  ...
  if (bass > bassthresh) {
    fill(16, 14, 81);
    rect(random(0, width/5), random(10, height), rad, rad);
    // rect(0, 0, width/5, height);
  } 

  if (lowMid > lowMidThresh) {
    fill(50, 12, 245);
    rect(random(width/5, width/5 * 2), random(10, height), rad, rad);
    // rect(width/5, 0, width/5, height);
  }

  if (mid > midthresh) {
    fill(203, 80, 202);
    rect(random(width/5 * 2, width/5 * 3), random(10, height), rad, rad);
    // rect(width/5 * 2, 0, width/5, height);
  }

  if (highMid > highMidThresh) {
    fill(12, 171, 245);
    rect(random(width/5 * 3, width/5 * 4), random(10, height), rad, rad);
